...
raw_data: requirements
	kaggle datasets download -d iammustafatz/diabetes-prediction-dataset -p data/raw
	$(PYTHON_INTERPRETER) makefile_scripts/unzip.py data/raw/diabetes-prediction-dataset.zip data/raw
	rm -f data/raw/diabetes-prediction-dataset.zip
